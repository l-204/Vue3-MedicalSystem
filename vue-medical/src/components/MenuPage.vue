        ...
        <el-header>
          ...
          <div class="horizontal-menu">
            ...
            <div class="left">
              ...
              <!-- 折叠按钮 -->
              <el-button @click="handleFold()" link type="primary" icon="Fold" :class="isCollapse ? 'fold' : 'unfold'">
              </el-button>
              <!-- 面包屑（目录） -->
            ...
            <div class="right">
              ...
              <div class="icon" v-if="!isMobile">
                ...
                <!-- 退出登录 -->
                <el-popconfirm confirm-button-text="确定" cancel-button-text="取消" icon="WarningFilled"
                  icon-color="#E6A23C" title="确定退出登录吗?" @confirm="logout()">
                  <template #reference>
